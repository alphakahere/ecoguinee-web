      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <InterventionListCard
            ...
            renderSecondary={(iv) => iv.agent?.name}
            detailHrefPrefix="/agent/interventions"
          />
        </div>
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-border bg-card p-5 space-y-4 lg:sticky">
            <div className="space-y-3">
              ...
              {report.linearMeters != null && (
                <div className="flex items-center justify-between">
                  <span className="text-xs font-mono text-muted-foreground uppercase">
                    Longueur curage
                  </span>
                  <span className="text-xs font-mono">{report.linearMeters} m</span>
                </div>
              )}
            </div>

				...
				<div className="flex items-center gap-2 shrink-0">
					{user ? (
						<>
							<Link
								href={`/${user.role}`}
								className="hidden md:flex items-center gap-2 px-4 py-2 rounded-lg border border-border text-sm font-mono text-muted-foreground hover:bg-muted/50 transition-all"
							>
								Tableau de bord
							</Link>
							<button

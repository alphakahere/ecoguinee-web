		...
		<>
			...
			>
				...
				<div
					...
					style={{
						background:
							"linear-gradient(to top, rgba(10,26,16,0.98) 0%, rgba(10,26,16,0.85) 30%, rgba(10,26,16,0.45) 60%, transparent 100%)",
					}}
				/>
					...
					<div className="flex flex-col gap-10 bg-white p-4 rounded-2xl border border-border">
						{campaign.description && (
							<section>
								...
								<p
									className="font-mono text-muted-foreground whitespace-pre-wrap"
									style={{
										fontSize: "0.95rem",
										lineHeight: 1.75,
									}}
								...
								<div
									...
									style={{
										borderLeft:
											"3px solid #6FCF4A",
										background:
											"rgba(111,207,74,0.05)",
										border: "1px solid rgba(111,207,74,0.2)",
									}}
								>
			...
			{lightboxIdx !== null && campaign.photos && (
				...
				>
					...
					<div
						className="absolute top-5 left-1/2 -translate-x-1/2 text-xs font-mono px-3 py-1 rounded-full"
						style={{
							background: "rgba(255,255,255,0.1)",
					...
					{lightboxIdx > 0 && (
						<button
							className="absolute left-5 w-12 h-12 rounded-full flex items-center justify-center"
							style={{
								background:
					...
					{lightboxIdx < campaign.photos.length - 1 && (
						<button
							className="absolute right-5 w-12 h-12 rounded-full flex items-center justify-center"
							style={{
								background:
									"rgba(255,255,255,0.1)",
							}}
					...
					<div
						className="relative w-[min(90vw,1400px)] h-[min(80vh,900px)] max-h-[80vh]"
						onClick={(e) => e.stopPropagation()}
					>
						<Image
							src={getImageUrl(
								campaign.photos[lightboxIdx],
							)}

		...
		>
			...
			<div
				...
				style={{
					...
					height: "600px",
					background:
						"radial-gradient(circle, rgba(111,207,74,0.2) 0%, transparent 65%)",
					top: "50%",
					left: "50%",
			...
			<div className="relative max-w-4xl mx-auto px-5 py-20 md:py-24 text-center">
				...
				>
					Pas besoin de créer un compte. 2 minutes suffisent
					pour soumettre un signalement.
				</motion.p>
				...
				>
					Vos signalements sont traités par les autorités
					locales et les agents certifiés EcoGuinée.
				</motion.p>
			</div>
		</section>
  );

...
import { Users, AlertTriangle, CheckCircle, Building2, Map, ArrowRight } from 'lucide-react';
    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-card rounded-2xl p-5 border border-border">
          <h3 className="font-semibold mb-1">Signalements par territoire</h3>
          <p className="text-xs font-mono text-muted-foreground mb-4">Répartition Conakry</p>
          <BarChart
        ...
        <div className="bg-card rounded-2xl p-5 border border-border">
          <h3 className="font-semibold mb-1">Répartition des utilisateurs</h3>
          <p className="text-xs font-mono text-muted-foreground mb-4">Par rôle</p>

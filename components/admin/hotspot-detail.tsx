...
import { InterventionListCard } from '@/components/shared/intervention-list-card';
import {
  REPORT_STATUS_META,
  SEVERITY_META_API,
  WASTE_TYPE_META,
...
export function HotspotDetail({ id }: { id: string }) {
  ...
  const attributionForm = canAssignOrganization ? (
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <InterventionListCard
            ...
            renderSecondary={(iv) =>
              iv.organization?.name ?? iv.organizationId.slice(0, 8)
            }
            detailHrefPrefix="/admin/interventions"
            headerExtras={attributionForm}
          />
        </div>
